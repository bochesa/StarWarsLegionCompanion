...
namespace StarWarsLegionCompanion.Api.Models
{
    public static class ModelBuilderExtensions
    {
        ...
        //    #region Seed Abilities
        //    //Premade Abilities
        //    var lukeJump = new Ability { Id = 1, keywordId = 1 };
        //    var lukeCharge = new Ability { Id = 2, keywordId = 2 };
        //    var lukeDeflect = new Ability { Id = 3, keywordId = 3 };
        //    var LukeImmune = new Ability { Id = 4, keywordId = 4 };
            
        //    builder.Entity<Faction>(a =>
        //    {
        //        a.HasData(lukeJump);
        //        a.HasData(lukeCharge);
        //        a.HasData(lukeDeflect);
        //        a.HasData(LukeImmune);
        //    });
        //    #endregion
        ...
        //    var lukeSaber = new UnitWeapon
        //    {
        //        Id = 1,
        //        Name = "Anakin's Lightsaber",
        //        RangeTypeId = 1,
        //        //AttackDie = { bd6 },
        //        //Keywords = new List<Keyword> { pierce2, impact2 }
        //    };
        //    var lukesBlaster = new UnitWeapon
        //    {
        //        Id = 2,
        ...
        //        MaxRange = 2,
        //        //AttackDie = { rd2 },
        //        //Keywords = new List<Keyword> { pierce2 }
        //    };

        //    builder.Entity<UnitWeapon>(w =>
        //    {
        ...
        //        MinisInUnit = 1,
        //        UnitTypeId = 1, 
        //        Ablities = {lukeJump, lukeCharge, lukeDeflect, LukeImmune},
        //        //    Weapons = { lukeSaber, lukesBlaster },
        //        //    UpgradeCategory = { gear, force, force2 },
        //    };
